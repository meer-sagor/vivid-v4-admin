        ...
        <div class="col-12">
            <div class="card">
                ...
                >
                        ...
                        <div class="flex flex-column md:flex-row md:justify-content-between md:align-items-center">
                            ...
                            <div class="flex flex-column md:flex-row md:justify-content-between md:align-items-center gap-3">
                                ...
                                <div class="flex gap-2 md:align-items-center">
                                    ...
                                    <Dropdown id="inventoryStatus" v-model="product.inventoryStatus" :options="statuses" optionLabel="label" placeholder="Select a Type">
                    ...
                    <Column field="order" header="Order" :sortable="true" headerStyle="width:14%; min-width:10rem;">
                ...
                <Dialog v-model:visible="productDialog" :style="{ width: '450px' }" header="Edit Details" :modal="true" class="p-fluid">
                    <div class="field">
                        ...
                        <InputText id="name" v-model.trim="product.name" required="true" type="number" value="0" autofocus :class="{ 'p-invalid': submitted && !product.name }" />
