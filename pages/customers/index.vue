...
const deleteAssociate = async () => {
  const { data, error } = await useApiFetch("/api/customers/" + id.value, {
    method: "DELETE",
  });
    ...
    <div class="col-12">
      <div class="card">
        ...
        >
          ...
          <Column field="username" header="Username" style="width: 5%"></Column>
          ...
          <Column :exportable="false" style="min-width: 8rem">
            <template #body="slotProps">
              <NuxtLink
                  ...
                  :to="{ path: '/customers/update/' + slotProps.data.id }"
              >
