            ...
            <div class="card p-fluid">
              ...
              <div class="formgrid grid">
                <div class="field col">
                  ...
                  />
                  <small class="p-error" id="product-url-key-error">{{
                    errors.url_key || "&nbsp;"
                  }}</small>
                </div>
                <div class="field col">
                  ...
                  <Field
                    ...
                    placeholder="Enter url key"
                  />
                  <small class="p-error" id="product-style-number-error">{{
                    errors.style_number || "&nbsp;"
                  }}</small>
                </div>
              </div>
              ...
              <div class="formgrid grid md:align-items-center">
                <div class="field col">
                  ...
                  />
                  <small class="p-error" id="product-sku-error">{{
                    errors.sku || "&nbsp;"
                  }}</small>
                </div>
                <div class="field col">
                  ...
                  />
                  <small class="p-error" id="product-quantity-error">{{
                    errors.quantity || "&nbsp;"
                  }}</small>
                </div>
              </div>
              ...
              <div class="field">
                <label for="size_chart_description" class="mb-3"
                  >Size Chart Description</label
                >
                <ClientOnly>
                  <QuillEditor
                      :content="product.size_chart_description"
                    ref="editor"
          ...
          <div class="col-4">
            <div class="card p-fluid">
              ...
              <div class="field col">
                ...
                <small class="p-error" id="product-category-id-error">{{
                  errors.category_id || "&nbsp;"
                }}</small>
              </div>
              <div class="field col">
                ...
                <small class="p-error" id="product-sub-category-id-error">{{
              ...
              <div class="field col">
                ...
                <small class="p-error" id="product-fabric-id-error">{{
                  errors.fabric_id || "&nbsp;"
                }}</small>
              </div>
              ...
              <div class="field col">
                ...
                <small class="p-error" id="product-brand-id-error">{{
                  errors.brand_id || "&nbsp;"
                }}</small>
              </div>
              ...
              <div class="field col">
                <div class="formgrid grid">
                  ...
                  <div class="field col">
                    <label for="name" class="flex mb-3"
                      >Default Embroidery</label
                    >
                          ...
                          <tr v-for="(field, idx) in fields" :key="idx">
                            <td>
                              <div class="flex flex-column gap-2 mb-2">
                                <Field
                                  :id="`size_id_${idx}`"
                                  :name="`size_charts[${idx}].size_id`"
                                  as="select"
                                  class="p-dropdown p-component p-inputwrapper p-inputwrapper-filled"
                                  style="padding: 0.75rem 0.75rem !important"
                                  v-slot="{ field }"
                                >
                                  <option
                            ...
                            <td>
                              <div class="flex flex-column gap-2 mb-2">
                                <Button
                                  v-if="values.size_charts.length > 1"
                                  @click="remove(idx)"
                                  icon="pi pi-times"
                      ...
                      <tbody>
                        <tr v-for="(field, idx) in fields" :key="idx">
                          <td>
                            <div class="flex flex-column gap-2 mb-2">
                              <Field
                                :id="`price_category_id_${idx}`"
                                :name="`price_shirt_charts[${idx}].price_category_id`"
                                as="select"
                                class="p-dropdown p-component p-inputwrapper p-inputwrapper-filled"
                                style="padding: 0.75rem 0.75rem !important"
                                v-slot="{ field }"
                          ...
                          <td>
                            <div class="flex flex-column gap-2 mb-2">
                              <Field
                                :id="`range_from_${idx}`"
                                :name="`price_shirt_charts[${idx}].range_from`"
                                v-slot="{ field }"
                              >
                                <input
                                  v-bind="field"
                                  ...
                                  :class="{
                                    'p-invalid':
                                      errors[
                                        `price_shirt_charts[${idx}].range_from`
                                      ],
                                  }"
                          ...
                          <td>
                            <div class="flex flex-column gap-2 mb-2">
                              <Field
                                :id="`range_to_${idx}`"
                                :name="`price_shirt_charts[${idx}].range_to`"
                                v-slot="{ field }"
                              >
                                <input
                                  v-bind="field"
                                  ...
                                  :class="{
                                    'p-invalid':
                                      errors[
                                        `price_shirt_charts[${idx}].range_to`
                                      ],
                                  }"
                          ...
                          <td>
                            <div class="flex flex-column gap-2 mb-2">
                              <Field
                                :id="`price_${idx}`"
                                :name="`price_shirt_charts[${idx}].price`"
                                v-slot="{ field }"
                              >
                                <input
                                  v-bind="field"
                          ...
                          <td>
                            <div class="flex flex-column gap-2 mb-2">
                              <Button
                                v-if="values.price_shirt_charts.length > 1"
                                @click="remove(idx)"
                                icon="pi pi-times"
                                class="p-button-rounded p-button-text mr-2 mb-2"
                              />
